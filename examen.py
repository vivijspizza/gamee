...
def movimiento():
    ...
    if posicion_food == posicion_snake[0]:
        ...
        canvas.create_text(*posicion_snake[-1], text= '🧑', fill='skin9', 
...
from tkinter inport messagebox

bef mostrar_anuncio():
    anuncio = "¡Descubre nuestro nuevo juego emocionante!"
    messagebox.showinfo("Anuncio", anuncio)

 Crear una ventana principal
ventana_principal = tk.Tk()
ventana_principal.title("Mi Juego")

 Crear un botón para mostrar el anuncio
boton_mostrar_anuncio = tk.Button(ventana_principal, text="Mostrar Anuncio", command=mostrar_anuncio)
boton_mostrar_anuncio.pack(padx=20, pady=20)
